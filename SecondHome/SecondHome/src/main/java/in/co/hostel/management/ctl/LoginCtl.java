...
import in.co.hostel.management.form.ChangePasswordForm;
import in.co.hostel.management.form.ForgetPasswordForm;
import in.co.hostel.management.form.LoginForm;
import in.co.hostel.management.form.MyProfileForm;
import in.co.hostel.management.form.UserRegistrationForm;
...
public class LoginCtl extends BaseCtl {
	...
	public String display(@ModelAttribute("form") @Valid ForgetPasswordForm form, BindingResult bindingResult,
		...
		UserDTO dto = service.findByUserName(form.getEmail());
