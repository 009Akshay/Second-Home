...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item linkSize active" aria-current="page"> <i class="fa fa-arrow-right" aria-hidden="true"></i> Allot Room</li>
  </ol>
</nav>
</div>
<hr>
<div class="container"> 
	<sf:form method="post"
		action="${pageContext.request.contextPath}/ctl/allotment"
		modelAttribute="form">
		<div class="card">
			<h5 class="card-header"
				style="background-color: #074235; color: white;">Allot Room</h5>
			<div class="card-body">
				...
				<div class="col-md-6">
					...
					<sf:select style="margin-bottom: 10px" class="form-control"
								...
								<sf:options itemLabel="roomNo" itemValue="id" items="${roomList}" />
							</sf:select>
