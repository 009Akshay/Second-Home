...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item linkSize active" aria-current="page"> <i class="fa fa-arrow-right" aria-hidden="true"></i> Application</li>
  </ol>
</nav>
</div>
<hr>
	...
	<sf:form method="post"
		...
		<div class="card">
			<h5 class="card-header"
				style="background-color: #074235; color: white;">Application</h5>
			<div class="card-body">
