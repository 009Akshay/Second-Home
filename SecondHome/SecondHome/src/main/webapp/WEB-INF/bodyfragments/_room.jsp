...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item linkSize active" aria-current="page"> <i class="fa fa-arrow-right" aria-hidden="true"></i> Room</li>
  </ol>
</nav>
</div>
<hr>
	...
	<sf:form method="post"
		...
		<div class="card">
			<h5 class="card-header"
				style="background-color: #074235; color: white;">Room</h5>
			<div class="card-body">
				...
				<div class="col-md-6">
					<s:bind path="roomNo">
						...
						<sf:input path="${status.expression}"
							placeholder="Enter  Room No" class="form-control" />
						<font color="red" style="font-size: 13px"><sf:errors
								path="${status.expression}" /></font>
					</s:bind>
				</div>
				...
				<div class="col-md-6">
					<s:bind path="facilities">
						<label for="inputEmail4" class="form-label">Facilities</label>
						<sf:textarea path="${status.expression}"
							placeholder="Enter Facilities" rows="4" cols="4" class="form-control" />
						<font color="red" style="font-size: 13px"><sf:errors
								path="${status.expression}" /></font>
					</s:bind>
				</div>
